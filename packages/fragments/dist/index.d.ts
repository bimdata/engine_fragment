...
export declare class Editor {
     ...
     */
    clearElementsRequests(modelId: string): EditRequest[];
    /**
     ...
     */
    createElements(modelId: string, elements: NewElementData[]): Promise<Element_2[]>;
    /**
...
export declare class FragmentsModel {
     ...
     */
    getLocalIdsByGuids(guids: string[]): Promise<number[]>;
    /**
     * Get all the categories of the model.
     */
    getCategories(): Promise<string[]>;
    getItemsWithGeometryCategories(): Promise<string[]>;
    /**
    ...
    getAlignmentStyles(): Promise<{
        ...
        get(key: AlignmentCurveType): LineMaterial;
     ...
     */
    rectangleRaycast(data: RectangleRaycastData): Promise<RectangleRaycastResult>;
    /**
     * Performs a raycast on the model.
     * @param data - The data of the raycast.
     */
    raycast(data: RaycastData): Promise<RaycastResult>;
    /**
     * Performs a raycast on the model and returns all the results.
     * @param data - The data of the raycast.
     */
    raycastAll(data: RaycastData): Promise<RaycastResult[]>;
    /**
     * Performs a raycast on the model with snapping.
     * @param data - The data of the raycast.
     */
    raycastWithSnapping(data: SnappingRaycastData): Promise<RaycastResult[]>;
    /**
...
declare function getGlobalTransformsIds(model: TFB.Model): any[] | Uint32Array;
...
declare function getLocalTransformsIds(model: TFB.Model): any[] | Uint32Array;
...
declare function getMaterialsIds(model: TFB.Model): any[] | Uint32Array;
...
declare function getRepresentationsIds(model: TFB.Model): any[] | Uint32Array;
...
declare function getSamplesIds(model: TFB.Model): any[] | Uint32Array;
...
declare class Item {
     ...
     */
    getLocalId(): Promise<number>;
    private _attributes;
    /**
     * Gets all the attributes of the item.
     */
    getAttributes(): Promise<ItemAttributes>;
    private _relations;
    /**
     * Gets all the relations of the item to other items.
     */
    getRelations(): Promise<ItemRelations>;
    private _guid;
    /**
    ...
    private _geometry;
    getGeometry(): Promise<ItemGeometry>;
    /**
...
declare class ItemGeometry {
     ...
     */
    getIndices(): Promise<Uint8Array[] | Uint16Array[] | Uint32Array[]>;
    private _transform;
    /**
     * Gets the transform of the item.
     */
    getTransform(): Promise<THREE.Matrix4[]>;
    private _normals;
    /**
     * Gets the normals of the item.
     */
    getNormals(): Promise<Int16Array[]>;
    private _positions;
    /**
     * Gets the positions of the item.
     */
    getPositions(): Promise<Float32Array[] | Float64Array[]>;
    private _vertices;
    /**
     * Gets the vertices of the item.
     */
    getVertices(): Promise<THREE.Vector3[][]>;
    private _triangles;
    /**
     * Gets the triangles of the item.
     */
    getTriangles(): Promise<THREE.Triangle[][]>;
    private _position;
    /**
     * Gets the position of the item.
     */
    getPosition(): Promise<THREE.Vector3[]>;
    private _box;
    /**
     * Gets the box of the item.
     */
    getBox(): Promise<THREE.Box3[]>;
    /**
...
declare class ItemRelations extends Map<string, Set<number>> {
     ...
     * @param key - The key of the relation.
     */
    getItems(key: string): Promise<Item[]>;
}
...
declare class MaterialManager {
    ...
    getHighlightProps(highlightIndex: number, originalIndex: number, modelId: string): MaterialDefinition;
...
declare class RaycastController {
    ...
    static cast(mesh: VirtualMeshManager, representation: Representation, ray: THREE.Ray, frustum: THREE.Frustum, snap?: SnappingClass): any[];
...
export declare class SingleThreadedFragmentsModel {
     ...
     * @param guids - Array of GUIDs to look up.
     */
    getLocalIdsByGuids(guids: string[]): number[];
    /**
     * Get all the categories of the model.
     */
     ...
     * @param localIds - Array of local IDs to look up.
     */
    getGuidsByLocalIds(localIds: number[]): string[];
    /**
     * Get the buffer of the model.
     * @param raw - Whether to get the raw buffer. If false, it will be compressed.
     */
    getBuffer(raw?: boolean): Uint8Array | ArrayBuffer;
    /**
     * Get a buffer containing only the specified items and their associated geometry.
     * @param localIds - The local IDs of the items to include.
     * @param raw - Whether to get the raw buffer. If false, it will be compressed.
 ...
 */
export declare function split(deps: IfcSplitterDeps, inputPath: string, numGroups: number, outputDir?: string): void;
...
declare class VirtualFragmentsModel {
    ...
    getItemsCategories(ids: number[]): string[];
    ...
    getItemsWithGeometry(): number[];
    getItemsWithGeometryCategories(): string[];
    getItemsByQuery(params: ItemsQueryParams, config?: ItemsQueryConfig): number[];
    getItemRelations(id: number): Record<string, number[]>;
    getSpatialStructure(): any;
    getMaxLocalId(): number;
    getCategories(): string[];
    getMetadata(): any;
...
declare class VirtualPropertiesController {
    ...
    getGuids(): string[];
    getLocalIds(): number[];
    getItemsCategories(ids: Identifier[]): string[];
    getLocalIdsByGuids(guids: string[]): number[];
    getGuidsByLocalIds(localIds: number[]): string[];
    getAttributeNames(): string[];
    getAttributeValues(): any[];
    ...
    getItemRelations(id: Identifier): Record<string, number[]>;
    getCategories(): string[];
    getItemsOfCategories(categories: RegExp[]): {
        [category: string]: number[];
    };
